...
public class SpecialSpectralColorMap extends ColorMap
{
     ...
     * Constructor
     */
    public SpecialSpectralColorMap(int size, int bits) {
        super(size, bits);
    }
