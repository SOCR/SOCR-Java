...
public final class Functions {
     ...
     * (nonnegatie numbers that sum to 1). Negative numbers in the original
     * array are converted to zeros, and the remaining numbers scaled by the sum
     * of the numbers, assuming that not all of the original numbers are 0. In
     * the last case, the method returns the uniform probabiltiy array.
     * 
    ...
    /**
     * This method computes the number of permuatations of a specified number of
     * objects chosen from a population of a specified number of objects.
     * 
    ...
    /**
     * This method computes the factorial function, the number of permutations
     * of a specified number of objects.
     * 
    ...
    /**
     * This method computes the number of combinations of a specified number of
     * objects chosen from a population of a specified size.
     * 
     * @param n the population size
     * @param k the sample size
     ...
     * used in the gamma cumulative distribution function.
     * 
     * @param x a positive number
     * @param a the shape parameter
    ...
    public static double betaCDF(double x, double a, double b) {
        double bt;
        if ((x == 0) | (x == 1)) bt = 0;
        else bt = Math.exp(logGamma(a + b) - logGamma(a) - logGamma(b) + a
    ...
    public static int[] getSample(int[] p, int n, int t) {
        ...
        if (t == WITH_REPLACEMENT) {
            ...
            for (int i = 0; i < n; i++) {
                ...
                s[i] = p[u];
                //Interchange the sampled element p[u] with p[k - 1], at the
                // end of the
