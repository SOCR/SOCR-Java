...
public class ConfidenceCanvasGeneral extends JPanel{
     ...
     */
    public ConfidenceCanvasGeneral(int n, int nTrials) {
       
    //    
        upperPanel= new ConfidenceCanvasGeneralUpper(n, nTrials);
        lowerPanel= new ConfidenceCanvasGeneralLower(n, nTrials);
  ...
  /*  public Dimension getPreferredSize() {
    ...
    public void clear(int n, int nTrials, Distribution dist) {
       ...
       upperPanel.clear(n, nTrials, dist);
       lowerPanel.clear(n, nTrials, dist);
       repaint();
    }
    ...
    public static double getMaxValueFrom2DArray(double[][] dataArray) {
        ...
        return upperPanel.getMaxValueFrom2DArray(dataArray);
    }

    public static double getMinValueFrom2DArray(double[][] dataArray) {
       return upperPanel.getMinValueFrom2DArray(dataArray);
    }
