...
/*
   public Dimension getPreferredSize() {
    ...
    public void paintComponent(Graphics g) {
      ...
      //  System.out.println("lowerPabel done drawing missedCount="+missedCount);
    }
        ...
        for (int trial = 0; trial < nTrials; trial++) {
          ...
          //  System.out.println("xbar="+x_bar);
            ...
            if (isOutsideTheInterval(unscaledCIUpperbound, unscaledCILowerbound))   // CI EXCLUDES the mean=0
            {
               ...
               // g.fillOval(xPos - MISSED_CIRCLE / 2, (scaledCILowerbound - scaledCIUpperbound) / 2 + scaledCIUpperbound, MISSED_CIRCLE, MISSED_CIRCLE);
