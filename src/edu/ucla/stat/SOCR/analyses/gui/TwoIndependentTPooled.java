...
public class TwoIndependentTPooled extends Analysis implements PropertyChangeListener {
	...
	resultPanelTextArea.append("\n\tVariable 1 = " + varHeader0);
	resultPanelTextArea.append("\n\tSample Size = " + yLength );
	resultPanelTextArea.append("\n\tSample Mean = " + result.getFormattedDouble(meanY));
	resultPanelTextArea.append("\n\tSample Variance = " + result.getFormattedDouble(varY));
	resultPanelTextArea.append("\n\tSample SD = " + result.getFormattedDouble(sdY));

	resultPanelTextArea.append("\n\n\tVariable 2 = " + varHeader1);
	resultPanelTextArea.append("\n\tSample Size = " + xLength);
	resultPanelTextArea.append("\n\tSample Mean = " + result.getFormattedDouble(meanX));
	resultPanelTextArea.append("\n\tSample Variance = " + result.getFormattedDouble(varX));
	resultPanelTextArea.append("\n\tSample SD = " + result.getFormattedDouble(sdX));

	resultPanelTextArea.append("\n\n\tDegrees of Freedom = " + df);
	resultPanelTextArea.append("\n\tPooled Sample Variance = " + result.getFormattedDouble(poolSampleVar));
	resultPanelTextArea.append("\n\tPooled Sample SD = " + result.getFormattedDouble(poolSampleSD));

	resultPanelTextArea.append("\n\tT-Statistics (Pooled) = " + result.getFormattedDouble(tStatPooled));
	//resultPanelTextArea.append("\n\tOne-Sided P-Value (Pooled) = " + AnalysisUtility.enhanceSmallNumber(pValueOneSidedPooled));
	//resultPanelTextArea.append("\n\tTwo-Sided P-Value (Pooled) = " + AnalysisUtility.enhanceSmallNumber(pValueTwoSidedPooled));
	resultPanelTextArea.append("\n\tOne-Sided P-Value (Pooled) = " + result.getFormattedDouble(pValueOneSidedPooled));
	resultPanelTextArea.append("\n\tTwo-Sided P-Value (Pooled) = " + result.getFormattedDouble(pValueTwoSidedPooled));
