...
public class WilcoxonRankTest extends QSortAlgorithm {
	...
	public WilcoxonRankTest(DataCase[] groupA, DataCase[] groupB) {
		combo = QSortAlgorithm.rankCombinedLists(groupA, groupB);
