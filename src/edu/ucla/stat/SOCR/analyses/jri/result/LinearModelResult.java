...
public class LinearModelResult extends AnalysisResult{
	...
	public static final String TAG_predicted = "fitted";//"predicted";
	...
	protected ArrayList<Object> predictorList = new ArrayList<Object>();
	...
	protected Intercept getIntercept(Element element) {
		...
		System.out.println("LinearModelResult tStat = " + tStat);
	...
	protected PlotData getPlotData(Element element) {
		...
		System.out.println("LinearModelResult predictedString = " + predictedString);

		System.out.println("LinearModelResult residualsString = " + residualsString);

		StringTokenizer stkPredicted = new StringTokenizer(predictedString, DELIMINATOR);
		StringTokenizer stkResiduals = new StringTokenizer(residualsString, DELIMINATOR);
