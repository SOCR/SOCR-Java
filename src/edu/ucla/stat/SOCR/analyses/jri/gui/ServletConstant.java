...
SRI: SOCR to R interface.

Put all the constants here so it's easy to define, plus, other classes can be less messier.
*/
...
public class ServletConstant {
	...
	//public static final String ANALYSIS_SERVLET = "http://128.97.86.247/SOCRR/servlet/AnalysisServlet";
}
