	...
	public void doAnalysis(){
		...
		******************************************************************/
		...
		try {
			...
			xmlInputString = data.getAnalysisXMLInputString(AnalysisType.SIMPLE_LINEAR_REGRESSION);
			setXMLInputString(xmlInputString);
			System.out.println("\n\nSimpleLinearRegression xmlInputString =" + xmlInputString );
			xmlOutputString = getAnalysisOutputFromServer(xmlInputString);

			////System.out.println("\n\nSimpleLinearRegression PRINT FROM SERVER......... xmlOutputString =" + xmlOutputString );
			if (xmlOutputString.indexOf(errorTagStart) > 0) {
				...
				result = new SimpleLinearRegressionResult(xmlOutputString);
			}


		} catch (Exception e) {
			////System.out.println("SimpleLinearRegression callServer Exception " + e );
		}
		////System.out.println("SimpleLinearRegression errorOccurs " + errorOccurs );
