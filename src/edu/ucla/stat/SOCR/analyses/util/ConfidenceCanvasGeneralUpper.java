...
public class ConfidenceCanvasGeneralUpper extends ConfidenceCanvasGeneralBase {
    ...
    public void paintComponent(Graphics g) {
        ...
        if (sampleData != null ) {
            ...
            drawCI(sampleData, leftGap, midHeight, topGap, xInterval, g);
    ...
    private void drawCI(double sampleData[][], int leftGap, int
            midHeight, int topGap, int xInterval, Graphics g) {
        ...
        for (int trial = 0; trial < nTrials; trial++) {
          ...
          //  System.out.println("xbar="+x_bar);
            ...
            int redPos= xPos-xInterval/2-10; //swift to the left a bit
