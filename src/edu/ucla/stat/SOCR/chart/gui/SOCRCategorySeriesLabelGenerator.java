...
import org.jfree.data.category.*;
 ...
 public class SOCRCategorySeriesLabelGenerator extends StandardCategorySeriesLabelGenerator { 
	...
	public SOCRCategorySeriesLabelGenerator() { 
		super(); 
	...
	public String generateLabel(CategoryDataset dataset, int series){ 
		...
		String k = (String)dataset.getRowKey(series);
		if (k.length()>0)
			return dataset.getRowKey(series)+":"+s.getSeriesSummary(series)+"\n";
		else
			return s.getSeriesSummary(series)+"\n";
