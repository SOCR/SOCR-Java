 ...
 */
public class StatisticalLineChartDemo3 extends SuperCategoryChart_Stat_Raw_Vertical implements PropertyChangeListener {
	public void doTest(){
		 JFreeChart chart;
		 ChartGenerator_JTable chartMaker = new ChartGenerator_JTable();
		 
		 resetChart();
		 showMessageDialog("StatisticalLineChartDemo3 doTest get called!");
