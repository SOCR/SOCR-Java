...
//import jfreechart.org.jfree.data.xy.XYDataset;
 ...
 * 
 */
public class  Chart3DDemo1_ArrayInput extends Super3DChart implements PropertyChangeListener {
    ...
    protected SOCRBinned2DData createBinned2DData(boolean isDemo) {
    	...
    	SOCRBinned2DData data= null;
    	
    	try {
    		
    		//String pathName = getPathName("test4040.data");
    		// if file is packed in jars/3d_data dir
    		//	String pathName = "3d_data"+System.getProperty("file.separator")+"array40x40.data";
    		//	data = new SOCRBinned2DData(codeBase, pathName);
    		
    		// this data file is packed in the jar file
    		String pathName = "array40x40.data";
    		URL url = getClass().getResource(pathName);
    		data = new SOCRBinned2DData(url);
    		} catch (IOException e) {
			e.printStackTrace();
		}
