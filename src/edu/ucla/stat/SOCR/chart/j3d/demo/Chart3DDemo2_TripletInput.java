 ...
 * 
 */
public class  Chart3DDemo2_TripletInput extends Super3DChart implements PropertyChangeListener {
    ...
    protected SOCRBinned2DData createBinned2DData(boolean isDemo) {
    	...
    	try {
    		//String pathName = getPathName("triplets.data");
    		// if data is packed at jars/3d_data dir
    		//String pathName = "3d_data"+System.getProperty("file.separator")+"triplet111x111.data";    		
    		//data = new SOCRBinnedTriplet2DData(codeBase, pathName);
    		
    		// this data file is packed in the jar file
    		String pathName = "triplet111x111.data";
    		URL url = getClass().getResource(pathName);
    		data = new SOCRBinnedTriplet2DData(url);
		} catch (IOException e) {
			e.printStackTrace();
		}
