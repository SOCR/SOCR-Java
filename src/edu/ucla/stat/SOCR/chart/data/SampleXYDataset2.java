...
public class SampleXYDataset2 extends AbstractXYDataset implements XYDataset,
    ...
    /**
	 * The x values.
	 * @uml.property  name="xValues" multiplicity="(0 -1)" dimension="2"
	 */
    private Double[][] xValues;

    /**
	 * The y values.
	 * @uml.property  name="yValues" multiplicity="(0 -1)" dimension="2"
	 */
    ...
    /**
	 * The number of items.
	 * @uml.property  name="itemCount"
	 */
    private int itemCount;

    /**
	 * The minimum domain value.
	 * @uml.property  name="domainMin"
	 */
    private Number domainMin;

    /**
	 * The maximum domain value.
	 * @uml.property  name="domainMax"
	 */
    private Number domainMax;

    /**
	 * The minimum range value.
	 * @uml.property  name="rangeMin"
	 */
    private Number rangeMin;

    /**
	 * The maximum range value.
	 * @uml.property  name="rangeMax"
	 */
    private Number rangeMax;

    /**
	 * The range of the domain.
	 * @uml.property  name="domainRange"
