...
* @version August, 2003
*/
public class Game extends JApplet implements ActionListener, ItemListener, ChangeListener, MouseListener, MouseMotionListener, Serializable{
	//Variables
	...
	*/
	public void playnote(int i){
		//play(getCodeBase(), "edu/uah/math/sounds/" + String.valueOf(i % 10) + ".au");
	}
}
