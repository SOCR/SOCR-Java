...
public abstract class Statistics {
    ...
    public static double getStdDev(Number[] data) {
        ...
        for (int counter = 0; counter < data.length; counter++) {
          if(data[counter]!=null){
                 current = data[counter].doubleValue();    
             }
             else {
                 current = Double.NaN;
             }
    ...
    /**
	  * Returns the sample Skewness measure of asymmetry of an array
	  of numbers.
	  * @param data   the sample data.
	  * @return sample Skewness measure of asymmetry of an array of
	  numbers.
	 */
	public static double calculateSkewness(Number[] data)
	{	// Returns the sample Skewness measure of asymmetry of an array of numbers.
		double avg = calculateMean(data, false);
		double sd = getStdDev(data);
		double sum = 0.0;
		int count = 0;
		double current;
		if (data.length > 1)
	...
	/**
	* Returns the sample Kurtosis measure of flatness of an array of numbers.
	* @param data   the sample data.
	* @return sample Kurtosis measure of flatness of an array ofnumbers.
	*/
	public static double calculateKurtosis(Number[] data)
	{	// Returns the sample Kurtosis measure of flatness of an array of numbers.
		...
		if (data.length > 1)
			...
			return sum/( (count -1)*sd*sd*sd*sd );
			}
		else return 0.0;
	}
